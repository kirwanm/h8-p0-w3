//Week-3 Exercise 9 Mencari Mean
/*
...
function cariMean(arr) {
  var numPanjangArr = arr.length;
  var numJmlAngka = 0;
  var numMean = 0;

  for(var numCounter = 0; numCounter < numPanjangArr; numCounter++) {
    numJmlAngka += arr[numCounter];
  }
  return Math.round(numJmlAngka / numPanjangArr);
}
